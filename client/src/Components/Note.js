  ...
  return (
    <>
      {storeQuestion?.map((questions, index) => (
        <div className="flex flex-col justify-start items-start w-full lg:w-[69rem] border border-green-500 dark:border-[2px] dark:border-blue-500 lg:h-40  rounded-md drop-shadow-lg shadow-green-500 mt-8 p-4">
          ...
          <div className="w-full flex items-center md:h-20 sm:min-h-[100px] xs:min-h-[120px] px-3 text-2xl font-normal font-NavbarLink text-green-500 dark:text-blue-500">
            {questions.group}
          </div>
        </div>
      ))}

    ...
    <>
      {notesQuery?.map((questions, index) => (
        <div
          ...
          className="flex flex-col justify-start items-start  lg:w-[62rem] md:w-[47rem] sm:w-[40rem] xs:w-[28rem] w-[23rem] border border-green-500 dark:border-[2px] dark:border-blue-500 lg:max-h-56  rounded-md drop-shadow-lg shadow-green-500  p-4"
        >
